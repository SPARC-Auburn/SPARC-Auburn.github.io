...
<?php include("../sidemenu.php") ?>
		...
		<td id="infoWindow" align="justify" rowspan="3" colspan="1">
        	<center>
            <h4>IEEE SouthEast Conference Robotics September Calender</h4>
            <br />
			<?php include("../calendarFile.php") ?>
            <?php
			$time = time();
			$days = array(
		    	2  => array('/special/NewMemberMeetings.php','linked-day'),
				9  => array('/special/NewMemberMeetings.php','linked-day'),
				16 => array('/special/NewMemberMeetings.php','linked-day'),
			);
			echo generate_calendar(2008, 9, $days);
			?>
            </center>
		</td>
	</tr>
